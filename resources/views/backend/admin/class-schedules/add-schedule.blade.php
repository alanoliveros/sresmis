<div class="modal fade" id="add-schedule{{$subject->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="{{route('add-schedule-by-section')}}" method="POST">
            @csrf
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <label for="validationDefault02" class="form-label text-dark">Select Teacher<small class="text-danger">(required)</small> </label>
                            ...
                            <div class="col-md-12">
                                <label for="validationDefault02" class="form-label text-dark">Start Time<small class="text-danger">(required)</small> </label>
                                <input type="time" class="form-control" name="startTime">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault02" class="form-label text-dark">End Time<small class="text-danger">(required)</small> </label>
                                <input type="time" class="form-control" name="endTime">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault02" class="form-label text-dark">Section Day<small class="text-danger"> (Note: Press hold <u>Ctrl+LeftCLick</u> to select multiple value)</small></label>
