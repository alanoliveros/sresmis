...
//Is it possible to create a seeder that will perform the following actions based on the value of currentStatuses:
//
//If the currentStatuses value is "Dropped Out," set the academicStatuses value to "NA," the remarks value to "NA," and the moving_up_status to "NA."
//If the currentStatuses value is "Transferred," set the academicStatuses value to "Transferred," the remarks value to "NA," and the moving_up_status to "NA."
//If the currentStatuses value is "NA," set the academicStatuses value to "NA," the remarks value to "NA," and the moving_up_status to "NA."
//If the currentStatuses value is "Continuing," set the academicStatuses value to "Enrolled," the remarks value to "Passed," and the moving_up_status to "Promoted."
//If the currentStatuses value is "Continuing," set the academicStatuses value to "Enrolled," the remarks value to "Failed," and the moving_up_status to "Retained."
